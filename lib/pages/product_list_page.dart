...
import 'package:grow_fast_app/store/store.dart';
                                      ...
                                      Positioned(
                                        ...
                                        child: GestureDetector(
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                                shape: BoxShape.circle,
                                                color: currentProduct == index ? Style.redColor : Style.white),
                                            child: Center(
                                                child: Icon(
                                              Icons.favorite,
                                              color: currentProduct == index ? Style.white : Style.redColor,
                                              size: 10,
                                            )),
                                          ),
                                          onTap: () async {
                                            currentProduct = index;
                                            LocalStore.setId(lifOfProduct?[index]?.id ?? 0);
                                            List<String> list = await LocalStore.getId();
